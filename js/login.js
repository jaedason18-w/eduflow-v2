...
const GOOGLE_LOADING = `<span class="google-spinner" aria-hidden="true"></span> Signing in with Google…`
...
// ---- ERROR MAP ----
const ERROR_MAP = {
  'Invalid login credentials': 'No account found with this email and password. Please check your details or register first.',
  'Email not confirmed':       'Please confirm your email before signing in. Check your inbox for a confirmation link.',
